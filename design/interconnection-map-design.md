...
The five functional requirements above describe what the map must do. This section describes how it should feel to use it — drawing on the work of practitioners who have solved analogous problems in immersive and installation contexts.

**Temporal compression as revelation.** Static maps show systems as they are. The interconnection map should show systems as they move — because movement is what reveals metabolism, causality, and the scale of consequence that is invisible in a snapshot. Marshmallow Laser Feast's *Water Body* compresses a year of planetary water circulation into ten seconds: rivers swell, nutrients flow to sea, phytoplankton blooms unfold, whale migrations follow. The viewer does not read about these connections — they watch them happen, and the watching produces a different quality of understanding than reading could. The interconnection map's animation layer should be designed with the same principle: not animation as decoration but animation as the primary mode of making systemic causality felt.

**Scale collapse.** The map must be able to move between the molecular and the planetary without the experience fragmenting. *Breathing with the Forest* achieves this by synchronising the viewer's breath — a five-second human cycle — with the movement of oxygen molecules through mycorrhizal networks. The personal body and the forest body become, briefly, the same rhythm. The interconnection map should have an equivalent mechanism: the ability to move from a specific village's water source to the continental watershed to the global climate system and back, with the transitions feeling continuous rather than jarring. The human and the planetary must feel like the same scale of concern, not different screens.

**The invisible made visible as phenomenon, not argument.** Both MLF works specifically visualise what cannot be seen with the naked eye — oxygen molecules in xylem, ocean nutrients in current, the breathing of a forest. The interconnection map's argument is the same: the connections between commons abuses are real but invisible to most people most of the time. The design imperative is to make them visible as phenomenon — something the viewer witnesses rather than reads about — not as argument. The map should never feel like it is trying to persuade. It should feel like it is simply showing.

**Synchronisation with the human body.** The most powerful moment in *Breathing with the Forest* is the instruction to synchronise your own breath with the forest's respiratory cycle. This is not decorative — it is the work's central mechanism, producing the experience of not being separate from the system being observed. The interconnection map's interaction design should look for equivalent moments of synchronisation: ways of connecting the user's own location, their own community, their own question to the planetary system being displayed, so that the map does not feel like a view from outside but like a view from within.
...
**Marshmallow Laser Feast** (marshmallowlaserfeast.com) are the most directly relevant practitioners to the experiential ambition of the interconnection map. Their works *Breathing with the Forest* and *Water Body* demonstrate at installation scale exactly what the map is reaching toward: invisible systems made legible through temporal compression, scale collapse, and synchronisation with human bodily experience. *Water Body* compresses a year of planetary water circulation into ten seconds — ocean currents, river networks, whale migrations, phytoplankton blooms — revealing water as a living planetary metabolism rather than a resource. *Breathing with the Forest* synchronises the viewer's breath with five-second molecular cycles in the mycorrhizal network, collapsing the distance between the human body and the forest body until they feel like the same system. Both works draw on NASA satellite data, Copernicus Marine Service, and global scientific archives — exactly the data sources the interconnection map would use. The experiential design principles MLF have developed — temporal animation as a core feature rather than a nice-to-have, scale collapse from molecular to planetary, the invisible made visible as phenomenon rather than argument — should be studied and partially adopted by anyone designing the interconnection map interface. A formal conversation with MLF as design consultants or collaborators is worth pursuing once the protocol has sufficient institutional standing.

**Emergence Magazine** (emergencemagazine.org) is the editorial context in which MLF's work and adjacent thinking circulates — a publication at the intersection of ecology, culture, and spirituality that has built one of the most thoughtful audiences for exactly the register the Commons Protocol's public-facing materials are aimed at. Worth approaching as a publication venue for the essay "The God in the River" and as a community where natural collaborators may be found.

**Global Forest Watch** (globalforestwatch.org) provides live satellite data, queryable by location, deforestation alerts and carbon data overlaid, navigable by non-specialists. The UX approach — layered data, geographic specificity, accessible entry points — is directly relevant. A formal data partnership with Global Forest Watch is worth pursuing as both a data source and a design reference.
...
This document is offered to collaborators with expertise in geographic information systems, data visualisation, environmental science, humanitarian data systems, and immersive or installation-based experiential design. The most useful responses are: identified technical constraints in the proposed data architecture, interaction design approaches that have succeeded in making complex systems legible to non-specialist global audiences, data partnership opportunities with organisations maintaining relevant datasets, responses from practitioners working at the intersection of data visualisation and embodied experience (particularly those familiar with the work of Marshmallow Laser Feast and adjacent studios), and the low-bandwidth accessibility challenge — which is the most urgent practical constraint on the map's global reach.
