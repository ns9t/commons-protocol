...
It bears stating however, that producing a meaningful signal does require participation — not passive consumption. The active engagement of people who have made some effort to verify their presence and consider the questions put to them is required. A signal produced by people who have done something to be here means more than one produced by people who have not. The value of the record is inseparable from the effort behind it. This is not considered a barrier per se — it is what makes the signal worth producing.
...
If this document describes something you believe is necessary — not merely useful, but *necessary* — this is a call not to go and build your own version, but to come and build this one together.

What is needed now is a first reference implementation: one concrete, working version that demonstrates the protocol in practice. Not a competition. Not a proliferation of parallel experiments. A single, concentrated effort — many hands, one structure — that establishes the concept as real before it becomes many things.

Contribute to the design. Propose solutions to the open questions. Bring relevant technical, governance, or domain expertise. Translate this document. Connect it to existing work that shares its values.

The only condition: the principles travel with you. They are the load-bearing structure. The trunk must hold.
